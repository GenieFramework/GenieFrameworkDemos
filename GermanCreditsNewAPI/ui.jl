[
      ...
      row([
        ...
        cell(class="st-br", [
          bignumber("Bad credits total amount",
                    R"bad_credits_amount | numberformat",
                    icon="euro_symbol",
                    color="negative")
        ])
        cell(class="st-br", [
          bignumber("Good credits total amount",
                    R"good_credits_amount | numberformat",
                    icon="euro_symbol",
                    color="positive")
        ])
      ])
  ...
  row([
      cell(class="st-module", [
        ...
        plot(:age_amount_duration_plot, layout=:age_amount_duration_plot_layout, config = "{ displayLogo:false }")
      ])
    ])
